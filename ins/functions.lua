...
download_file('https://raw.githubusercontent.com/TEAMALLAM/M_ALLAM/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/TEAMALLAM/M_ALLAM/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/TEAMALLAM/M_ALLAM/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/TEAMALLAM/M_ALLAM/master/inc/functions.lua','./inc/functions.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(ALLAM..":NameBot:") or "علام"
...
var = 'هذا البوت 🙄☝🏿' 
elseif UserID == 1859656976 or UserID == 1830814795  then 
var = 'مطور السورس'
...
if UserID == 1859656976 or UserID == 1830814795 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
